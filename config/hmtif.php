...
return [
    ...
    /*
     * Deskripsi tugas dan wewenang jabatan divisi fungsionaris.
     */
    'division_roles' => [
        [
            'title' => 'Koordinator Bidang',
            'desc'  => 'Penanggung jawab utama di divisinya. Bertugas merancang Grand Design program kerja, memimpin jalannya eksekusi program, serta mengawasi kinerja, kedisiplinan, dan kesejahteraan seluruh fungsionaris di bidangnya.',
            'icon'  => 'flag',
        ],
        [
