...
<html lang="en">
  ...
  <body>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 w-[950px] h-[400px]">
        ...
        >
          <div class="grid grid-cols-3 gap-4 w-fit">
            <!-- Foto Kecil 1 -->
            <div
              class="swap-box bg-white p-4 w-28 h-28 flex items-center justify-center rounded-lg cursor-pointer transform transition duration-300 hover:scale-105"
    ...
    <div class="h-[550px] flex items-center justify-center bg-gray-100">
      <h1>ABOUT KABINET</h1>
      <div class="grid grid-cols-3 gap-4 w-full h-[450px] p-10">
        <!-- Box 1 -->
        <div class="flex flex-col gap-4">
          <div
            class="h-30 w-full flex flex-col text-black text-justify font-bold"
          >
            <h1 class="text-4xl">31+ Pengurus</h1>
          ...
          <div
            class="h-30 w-full flex flex-col text-black text-justify font-bold"
          >
            <h1 class="text-4xl">300+ Anggota</h1>
            <p class="text-xs mt-3">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eaque
              neque tempore repudiandae velit animi tempora amet corporis labore
              doloribus assumenda!
        ...
        <!-- Box 3 -->
        <div
          class="flex flex-col  text-3xl font-bold space-y-4"
        >
          <p class="text-base font-normal max-w-xl">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum
            dolor sit amet consectetur, adipisicing elit. Natus laboriosam,
