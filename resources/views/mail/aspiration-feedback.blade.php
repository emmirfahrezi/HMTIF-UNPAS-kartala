                ...
                <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width: 560px; width: 100%;">
                    ...
                    <tr>
                        <td align="center" style="padding-bottom: 32px;">
                            <img src="{{ config('app.logo_url') }}" alt="HMTIF UNPAS" width="48" height="48" style="border-radius: 12px;">
                        </td>
                    </tr>
                                    ...
                                    <td style="padding: 40px 36px;">
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border-radius: 12px; border: 1px solid #e2e8f0; margin-bottom: 24px;">
                                            <tr>
                                                <td style="padding: 20px 24px;">
                                                    {{-- Subject --}}
                                                    <p style="margin: 0 0 4px; font-size: 11px; font-weight: 800; color: #94a3b8; text-transform: uppercase; letter-spacing: 1.5px;">Subjek</p>
                                                    <p style="margin: 0 0 16px; font-size: 15px; font-weight: 700; color: #1e293b;">{{ $subject }}</p>

                                                    {{-- Status Badge --}}
                                                    <p style="margin: 0 0 4px; font-size: 11px; font-weight: 800; color: #94a3b8; text-transform: uppercase; letter-spacing: 1.5px;">Status</p>
                                                    ...
                                                    @if (!empty($trackingCode))
                                                        <p style="margin: 16px 0 4px; font-size: 11px; font-weight: 800; color: #94a3b8; text-transform: uppercase; letter-spacing: 1.5px;">Kode Tracking</p>
                                                        <p style="margin: 0; font-size: 14px; font-weight: 600; color: #475569; font-family: 'Courier New', monospace; background: #e2e8f0; display: inline-block; padding: 4px 12px; border-radius: 6px;">{{ $trackingCode }}</p>
                                                    @endif
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        @if (!empty($message))
                                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f0fdf4; border-radius: 12px; border: 1px solid #bbf7d0; margin-bottom: 24px;">
                                                <tr>
                                                    <td style="padding: 20px 24px;">
                                                        <p style="margin: 0 0 8px; font-size: 11px; font-weight: 800; color: #16a34a; text-transform: uppercase; letter-spacing: 1.5px;">💬 Pesan dari Admin</p>
