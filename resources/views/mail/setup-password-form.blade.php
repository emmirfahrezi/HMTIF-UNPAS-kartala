    ...
    <main class="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden py-12 px-4">
        ...
        <div class="w-full max-w-[440px] relative">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-slate-500 mt-2 font-medium">Buat password baru untuk mengaktifkan akun Anda</p>
            </div>
            ...
            <div x-data="{
                ...
                <form action="{{ route('setup-password.store') }}" method="POST" class="space-y-6" @submit="submitting = true" novalidate>
                    @csrf
                    ...
                    <div class="p-4 rounded-xl border border-blue-100 bg-blue-50/50 text-sm flex gap-3 items-start">
                        ...
                        <p class="text-blue-900/80 leading-relaxed text-xs">
                            Demi keamanan, harap gunakan kombinasi huruf dan angka (minimal 8 karakter).
                        </p>
                    </div>
                    ...
                    <x-molecules.pages.forms.form-field id="password_label" label="Password Baru" :required="true">
                        <div class="relative group">
                            ...
                            <button type="button" @click="showPassword = !showPassword"
                                ...
                                <span x-show="showPassword" style="display: none;"><x-heroicon-o-eye-slash class="size-5" /></span>
                            </button>
                        </div>
                        @error('password')
                    ...
                    <x-molecules.pages.forms.form-field id="password_confirmation_label" label="Konfirmasi Password" :required="true">
                        <div class="relative group">
                            <input
                                id="password_confirmation_field" name="password_confirmation"
                            ...
                            <button type="button" @click="showConfirmPassword = !showConfirmPassword"
                                ...
                                <span x-show="showConfirmPassword" style="display: none;"><x-heroicon-o-eye-slash class="size-5" /></span>
                            </button>
                        </div>
                    ...
                    <div class="pt-4">
                        ...
                        >
                            ...
                            <span x-show="submitting" class="flex items-center gap-2" style="display: none;">
                                <svg class="animate-spin size-4" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" fill="none"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                                Memproses...
                            </span>
                        </button>
                    </div>
