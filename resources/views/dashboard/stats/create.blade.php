        ...
        <div class="space-y-6 max-w-4xl">
            <x-molecules.dashboard.forms.form-section title="Data Statistik">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <x-molecules.dashboard.forms.form-input label="Label" name="label" required placeholder="Contoh: Anggota Aktif" />
                    <x-molecules.dashboard.forms.form-input label="Nilai" name="value" required placeholder="Contoh: 150+" />
                    <x-molecules.dashboard.forms.form-input label="Icon" name="icon" placeholder="heroicon-o-users" helper="Nama komponen Heroicon" />
                    <x-molecules.dashboard.forms.form-input type="number" label="Urutan" name="order" value="0" />
                </div>
