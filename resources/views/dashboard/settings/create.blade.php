        ...
        <div class="space-y-6 max-w-4xl">
            <x-molecules.dashboard.forms.form-section title="Setting">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <x-molecules.dashboard.forms.form-input label="Key" name="key" required placeholder="site_name" />
                    <x-molecules.dashboard.forms.form-input label="Value" name="value" required placeholder="HMTIF UNPAS" />
                    <x-molecules.dashboard.forms.form-input type="select" label="Group" name="group" value="general"
