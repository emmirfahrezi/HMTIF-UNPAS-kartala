<x-dashboard-layout pageTitle="Edit Kategori" :breadcrumbs="[['label' => 'Kategori Pengumuman', 'href' => '/dashboard/announcement-categories'], ['label' => 'Edit']]">
    <form method="POST" action="/dashboard/announcement-categories/{{ $category->id }}">@csrf @method('PUT')
