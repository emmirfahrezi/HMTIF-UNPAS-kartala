<x-dashboard-layout pageTitle="Tambah Kategori" :breadcrumbs="[['label' => 'Kategori Produk', 'href' => '/dashboard/product-categories'], ['label' => 'Tambah']]">
    <form method="POST" action="/dashboard/product-categories">@csrf
