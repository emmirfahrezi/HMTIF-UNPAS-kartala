<x-layouts.dashboard pageTitle="Edit Kategori" :breadcrumbs="[['label' => 'Pengumuman', 'href' => '/dashboard/announcements'], ['label' => 'Kategori', 'href' => '/dashboard/announcements/categories'], ['label' => 'Edit']]">
    <form method="POST" action="/dashboard/announcements/categories/{{ $category->id }}">@csrf @method('PUT')
