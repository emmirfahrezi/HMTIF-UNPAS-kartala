...
@php
    ...
    $isCreateOrEdit = str_contains($cleanPath, '/create') || str_contains($cleanPath, '/edit') || str_contains($cleanPath, '/reorder');
    $isShow = str_contains($cleanPath, '/show') || preg_match('/^[a-z\-]+\/[a-zA-Z0-9\-]+$/', $cleanPath) || (str_starts_with($cleanPath, 'aspirations/') && !str_contains($cleanPath, '/index'));
        ...
        <main class="flex-1 p-6 lg:p-10 relative">
            ...
            <div x-show="pageLoading" class="space-y-8 animate-pulse pointer-events-none select-none">
                ...
                @if ($skeletonType === 'overview')
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        <template x-for="i in 6">
                            <div class="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-5 space-y-4 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <template x-for="col in 3">
                            <div class="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 space-y-5 shadow-sm">
                                ...
                                <div class="space-y-4">
                                    <template x-for="row in 5">
                                        <div class="py-2 border-b border-slate-50 dark:border-slate-800/30 last:border-0 space-y-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <template x-for="i in 5">
                            <div class="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 space-y-5 shadow-sm">
                                ...
                                <div class="h-10 w-full bg-slate-50 dark:bg-slate-800/40 rounded-xl border border-slate-100 dark:border-slate-800/50"></div>
                            </div>
                        </template>
                    </div>
                ...
                @elseif ($skeletonType === 'profile')
                    <!-- PROFILE SKELETON -->
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 flex flex-col items-center space-y-6 shadow-sm">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            <div class="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 space-y-6 shadow-sm">
                ...
                @elseif ($skeletonType === 'settings')
                    <!-- SETTINGS SKELETON -->
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 space-y-6 shadow-sm">
                            <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
                                <div class="h-5 w-40 bg-slate-200 dark:bg-slate-800 rounded-lg"></div>
                                <div class="h-6 w-16 bg-slate-100 dark:bg-slate-800/80 rounded-full"></div>
                            </div>
                            <div class="space-y-4">
                                <div class="grid grid-cols-6 gap-4 text-xs font-bold text-slate-400 border-b border-slate-50 dark:border-slate-800/30 pb-2">
                                ...
                                <template x-for="i in 5">
                                    <div class="grid grid-cols-6 gap-4 items-center py-2 border-b border-slate-50 dark:border-slate-800/30 last:border-0">
                        ...
                        <div class="space-y-6">
                            <div class="h-24 w-full bg-blue-50/50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30 rounded-2xl p-4 flex items-start gap-3">
                            ...
                            <div class="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 space-y-4 shadow-sm">
                                ...
                                <div class="space-y-3 pt-2">
                                    ...
                                    <template x-for="i in 4">
                                        <div class="flex items-center gap-2 py-1">
                                            <div class="h-4 w-4 bg-slate-200 dark:bg-slate-800 rounded-full shrink-0"></div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 space-y-5 shadow-sm">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="border border-slate-100 dark:border-slate-800 rounded-xl overflow-hidden">
                                        <div class="h-10 w-full bg-slate-50 dark:bg-slate-950 border-b border-slate-100 dark:border-slate-800 flex items-center gap-2 px-3">
                        ...
                        <div class="space-y-6">
                            <div class="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 space-y-4 shadow-sm">
                                ...
                                <div class="space-y-2">
                                    <div class="h-4 w-24 bg-slate-200 dark:bg-slate-800 rounded"></div>
                                    <div class="h-12 w-full bg-slate-50 dark:bg-slate-800/40 rounded-xl border border-dashed border-slate-200 dark:border-slate-800 flex items-center justify-center">
                                        <div class="h-4 w-24 bg-slate-200 dark:bg-slate-800 rounded"></div>
                                    </div>
                                </div>
                            </div>
                ...
                @else
                    ...
                    <div class="h-16 w-full bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-4 flex items-center justify-between shadow-sm">
                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl overflow-hidden p-6 space-y-6 shadow-sm">
                        <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
                        ...
                        <div class="space-y-5">
                            <template x-for="i in 5">
                                <div class="flex items-center gap-4 py-2 border-b border-slate-50 dark:border-slate-800/30 last:border-0">
