<div
    ...
    <div class="absolute inset-0 bg-linear-to-b from-black/35 via-black/10 to-transparent z-0"></div>
    <div class="mx-auto max-w-4xl py-24 sm:py-32 z-20 text-center">
        ...
        <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 reveal reveal-up reveal-delay-4">
            ...
            <x-atoms.button variant="outline-secondary" onclick="window.location.href='/staff'"
