<div class="relative isolate px-6 pt-14 mt-0 lg:px-8 min-h-screen flex items-center bg-[url('https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center bg-no-repeat z-0 transform">
    ...
    <div class="mx-auto max-w-4xl py-24 sm:py-32 z-20 text-center">
        <div class="inline-flex items-center gap-2 px-3 py-1 bg-white/10 backdrop-blur-md rounded-lg text-primary-soft text-sm font-semibold mb-6 shadow-xl ring-1 ring-white/20 reveal reveal-up reveal-delay-1">
        ...
        <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-7xl mb-6 drop-shadow-2xl reveal reveal-up reveal-delay-2">
            HMTIF UNPAS <br>
        ...
        <p class="mt-4 text-base font-medium text-white/90 leading-relaxed max-w-2xl mx-auto sm:text-lg reveal reveal-up reveal-delay-3">
