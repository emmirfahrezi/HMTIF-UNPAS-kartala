<div class="py-24 bg-primary-dark text-white relative overflow-hidden">
    ...
    <div class="mx-auto px-6 lg:px-8 max-w-screen-2xl relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {{-- Visi --}}
            <div class="bg-white/5 backdrop-blur-md p-10 rounded-[2.5rem] border border-white/10 shadow-2xl reveal reveal-scale">
            ...
            {{-- Misi --}}
            <div class="bg-white/5 backdrop-blur-md p-10 rounded-[2.5rem] border border-white/10 shadow-2xl reveal reveal-scale reveal-delay-2">
