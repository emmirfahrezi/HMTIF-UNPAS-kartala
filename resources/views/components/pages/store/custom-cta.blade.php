    ...
    <div class="pb-24 bg-section/30">
        <div class="mx-auto px-6 lg:px-8 max-w-screen-2xl">
            <div class="bg-primary-dark rounded-lg p-10 md:p-16 relative overflow-hidden shadow-2xl group border border-white/10 reveal reveal-scale">
