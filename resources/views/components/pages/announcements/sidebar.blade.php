    ...
    <div class="space-y-8 reveal reveal-right">
        <div class="bg-white p-6 rounded-2xl border border-border shadow-sm">
            ...
            <ul class="space-y-3">
                @foreach(['Akademik', 'Kemahasiswaan', 'Lomba & Kompetisi', 'Organisasi'] as $cat)
        ...
        <div class="bg-primary p-6 rounded-2xl text-white shadow-lg shadow-primary/20 relative overflow-hidden group">
             <div class="absolute inset-x-0 bottom-0 h-1 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity"></div>
            ...
            <x-atoms.button variant="outline"
                ...
                class="w-full border-white text-white hover:bg-white hover:text-primary py-2 text-sm backdrop-blur-sm">
                Kirim Aspirasi
            </x-atoms.button>
        </div>
    </div>
