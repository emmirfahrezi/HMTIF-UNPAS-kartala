...
<section class="py-12 bg-white relative">
    ...
    <div class="mx-auto px-6 lg:px-8 max-w-5xl">
        <div
            ...
            <div
                class="absolute top-0 right-0 w-64 h-64 bg-primary rounded-full opacity-10 -mr-32 -mt-32 blur-3xl group-hover:scale-150 transition-transform duration-700">
            </div>

            <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div class="text-center md:text-left">
                    <h2 class="text-2xl font-black text-white italic uppercase tracking-tighter">Sudah Kirim <span
