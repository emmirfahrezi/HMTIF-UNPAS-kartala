                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <a href="{{ Str::startsWith($staff->linkedin, ['http://', 'https://']) ? $staff->linkedin : 'https://' . ltrim($staff->linkedin, '@') }}" 
                           target="_blank" rel="noopener noreferrer"
                           class="flex items-center gap-3 px-6 py-3 rounded-2xl bg-[#0077b5] text-white font-bold text-sm hover:-translate-y-1 hover:shadow-lg hover:shadow-[#0077b5]/25 transition-all duration-300">
                            <svg class="size-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
