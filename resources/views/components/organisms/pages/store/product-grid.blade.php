            ...
            <div id="product-grid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                @foreach ($products as $product)
                    ...
                    <div class="reveal reveal-up reveal-delay-{{ $delay++ }} flex flex-col h-full">
                        <div
                            class="group bg-white rounded-lg border border-gray-100 shadow-md hover:shadow-xl transition-all duration-700 overflow-hidden flex flex-col hover:-translate-y-2 cursor-pointer h-full">
