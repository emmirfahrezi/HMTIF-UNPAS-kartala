...
@php
    ...
    $menuGroups = [
        ...
        'Konten' => [
            ...
            ['label' => 'Kategori Pengumuman', 'icon' => 'heroicon-o-tag', 'href' => '/dashboard/announcement-categories', 'match' => 'dashboard/announcement-categories'],
        ],
        'Organisasi' => [
            ['label' => 'Pengurus', 'icon' => 'heroicon-o-users', 'href' => '/dashboard/staffs', 'match' => 'dashboard/staffs'],
            ['label' => 'Bidang/Divisi', 'icon' => 'heroicon-o-building-office', 'href' => '/dashboard/divisions', 'match' => 'dashboard/divisions'],
        ...
        'Store' => [
            ...
            ['label' => 'Kategori Produk', 'icon' => 'heroicon-o-rectangle-stack', 'href' => '/dashboard/product-categories', 'match' => 'dashboard/product-categories'],
        ],
        'Pengaturan' => [
...
<aside id="dashSidebar" class="dash-sidebar fixed top-0 left-0 h-screen bg-white border-r border-slate-200 flex flex-col overflow-y-auto">
    ...
    <div class="h-16 flex items-center gap-3 px-6 border-b border-slate-100 shrink-0">
        <div class="w-8 h-8 bg-primary rounded-lg flex items-center justify-center text-white font-black text-sm">H</div>
        <span class="font-bold text-slate-800 text-sm tracking-tight">HMTIF Dashboard</span>
    </div>
