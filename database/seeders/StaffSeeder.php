...
class StaffSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $staffs = [
            ...
            ['division_id' => $kominfo->id, 'name' => 'Alfi Mifta Nurhakim',        'position' => 'Staf Bidang',        'order' => 2, 'is_bph' => false, 'is_active' => true, 'photo' => null, 'bio' => 'Fullstack Developer Tim Pengembang Website HMTIF-UNPAS Kabinet Kartala.', 'instagram' => null, 'linkedin' => null],
            ['division_id' => $kominfo->id, 'name' => 'Aufa Ramadhan',              'position' => 'Staf Bidang',        'order' => 3, 'is_bph' => false, 'is_active' => true, 'photo' => null, 'bio' => 'Backend Developer Tim Pengembang Website HMTIF-UNPAS Kabinet Kartala.',   'instagram' => null, 'linkedin' => null],
